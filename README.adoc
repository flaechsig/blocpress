== Blocpress — printing made (mostly) simple

Blocpress is a lightweight document template/rendering engine.
...
Blocpress treats ODT as the source of truth for layout and formatting.
...
Render an ODT template from a URL and a JSON payload:
...
image::docs/images/fields_dialog.png[Fields Dialog (CTRL+F2)]
...
image::docs/images/field_value_view.png[Field Value View]

.Field Name View in LibreOffice
image::docs/images/field_name_view.png[Field Name View]
...
image::docs/images/projectstructure.png[Project structure]

[source,xml]
----
<dependency>
  <groupId>org.blocpress</groupId>
  <artifactId>blocpress-renderer</artifactId>
...
import org.blocpress.renderer.RenderEngine;
...
image::docs/images/user_field_gender.png[Define User Field customer.gender]
...
image::docs/images/conditional_text_customer_gener.png[Conditional text customer.gender]
...
image::docs/images/user_field_customer_index.png[]
...
.Field Value View
image::docs/images/section_with_field_data_view.png[]
...
.Field Name View
image::docs/images/field_name_view_with table.png[]
...
image::docs/images/list_result.png[]
...
image::docs/images/text_block.png[]
...
image::docs/images/text_block_processed.png[]
