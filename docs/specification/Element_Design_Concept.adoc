...
| 2 | name | String(255) | Name des Templates (nicht eindeutig, da versioniert)
| 3 | description | String(2000) | Beschreibung des Templates
| 4 | version | Integer | Versionsnummer (1, 2, 3, ...; UC-10.1: Auto-Versioning nach Name)
| 5 | status | String(50) | Status: "DRAFT", "SUBMITTED", "APPROVED", "REJECTED"
| 6 | validFrom | Timestamp | Aktivierungsdatum (UC-10.1); NULL bis APPROVED; wird auf now() gesetzt bei APPROVED Transition; kann von Admin auf zukünftiges Datum geändert werden für geplante Rollouts
| 7 | ersteller_id | UUID | Foreign Key zu E-9 (Benutzer)
| 8 | erstellungsdatum | Timestamp | Erstellungszeitpunkt
| 9 | content | bytea | ODT-Datei als Binärdaten (PostgreSQL BLOB)
| 10 | validation_result | JSONB | Validierungsergebnis: {errors: [...], warnings: [...], userFields: [...], repetitionGroups: [...], conditions: [...]}
| 11 | review_zyklus | Integer | Review-Zyklus in Jahren (1, 3 oder 5)
|===
...
| 1 | id | UUID | Eindeutige Baustein-ID (Primary Key, auto-generiert)
