...
| HOCH
| `@CacheInvalidate(cacheName="templates")` in `TemplateImportResource.importTemplate()` hinzufuegen
...
| HOCH
| MicroProfile Timeout-Annotation oder `quarkus.rest-client."render-import".connect-timeout=5000` konfigurieren
