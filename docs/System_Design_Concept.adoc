...
*Workflow Engine:* Komponente innerhalb von blocpress-server, die Freigabeprozesse und Compliance-Reviews steuert. Verwaltet Zustände, Übergänge, Benachrichtigungen und Berechtigungsprüfungen. +
...
*Compliance Manager:* Komponente innerhalb von blocpress-server, die Review-Zyklen überwacht, Fälligkeitstermine berechnet und Benachrichtigungen an Compliance-Reviewer sendet. +
...
9. blocpress-server aktualisiert den Review-Status und berechnet das nächste Review-Datum
